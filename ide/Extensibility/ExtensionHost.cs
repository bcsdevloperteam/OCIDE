...
namespace OCIDE.Extensibility
{
    ...
    public class ExtensionHost
    {
        ...
        public void DiscoverExtensions()
        {
            ...
            // System.Windows.MessageBox.Show($"Discovered {_extensions.Count} extensions.");
        }
        ...
        public void ActivateExtension(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Windows.Application.Current?.Dispatcher?.Invoke(() => {
                    System.Windows.MessageBox.Show($"Failed to load extension {id}:\n{ex.Message}", "Extension Error", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Error);
                });
            }
        }
